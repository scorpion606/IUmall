...
public class DtsRegionVO implements Serializable {
    public DtsRegionVO() {
    }

    public DtsRegionVO(Integer id, Integer pid, String name, Byte type, Integer code, Integer enabled, List<DtsRegionVO> dtsRegions) {
        this.id = id;
        this.pid = pid;
        this.name = name;
        this.type = type;
    ...
    private List<DtsRegionVO> dtsRegions;

    public List<DtsRegionVO> getDtsRegions() {
        return dtsRegions;
    }

    public void setDtsRegions(List<DtsRegionVO> dtsRegions) {
        this.dtsRegions = dtsRegions;
    }
