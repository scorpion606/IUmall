...
public class ProductSkuVo implements Serializable {
    ...
    public ProductSkuVo(Integer skuId, Integer productId, String skuName, String skuImg, Integer untilled, BigDecimal originalPrice, BigDecimal sellPrice, BigDecimal discount, Integer stock, Integer status, String oldness, Integer revision, String createdBy, Date createdTime, String updatedBy, Date updatedTime, Date purchasedTime, List<PmsSkuSaleAttrValue> pmsSkuSaleAttrValue, List<PmsSkuImages> pmsSkuImages) {
        this.skuId = skuId;
    ...
    private List<PmsSkuSaleAttrValue> pmsSkuSaleAttrValue;
    private List<PmsSkuImages> pmsSkuImages;
    ...
    public List<PmsSkuImages> getPmsSkuImages() {
        return pmsSkuImages;
    }

    public void setPmsSkuImages(List<PmsSkuImages> pmsSkuImages) {
        this.pmsSkuImages = pmsSkuImages;
    }
