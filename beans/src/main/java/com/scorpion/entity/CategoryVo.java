...
public class CategoryVo implements Serializable {
    ...
    public CategoryVo(Integer categoryId, String categoryName, Integer categoryLevel, Integer parentId, String categoryIcon, String categorySlogan, String categoryPic, String categoryBgColor, Integer categoryStyle, Integer categorySeq, Integer categoryStatus, String url, Integer deleted, List<CategoryVo> categories, List<ProductVo> products) {
