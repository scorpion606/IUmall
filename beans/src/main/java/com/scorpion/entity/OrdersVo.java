...
public class OrdersVo implements Serializable {
    ...
    public OrdersVo(String orderId, Integer userId, String productName, String receiverName, String receiverPhone, String receiverAddress, BigDecimal totalAccount, BigDecimal actualAccount, Integer payType, String orderRemark, String status, String deliveryType, String deliveryFlowId, BigDecimal orderFreight, Integer deleteStatus, Integer revision, String createdBy, Date createdTime, String updatedBy, Date updatedTime, Date payTime, Date deliveryTime, Date finishTime, Date cancelTime, Integer cancelType, List<OrderItem> orderItems) {
